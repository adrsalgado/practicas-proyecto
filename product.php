       ...
       <br>
        <div class="container">
            <div class="page-header">
              <h1>PRODUCTOS <small class="tittles-pages-logo">PROSALCO IPS</small></h1>
            </div>
            <?php
                    ...
                    <div class="col-xs-12 col-sm-6 col-md-4">
                         <div class="thumbnail">
                           ...
                           <div class="caption">
                             ...
                             <?php if($prod['invima']>0): ?>
                             <p>
                             <?php
                             $pref=number_format($prod['Precio']-($prod['Precio']*($prod['invima']/100)), 2, '.', '');
                             echo $prod['vencimiento']."vencimiento: ".$pref; 
                             ?>
                             </p>
                             <?php else: ?>
