...
$loteProdUp=consultasSQL::clean_string($_POST['prod-lote']);
$proveedorProdUp=consultasSQL::clean_string($_POST['prod-proveedor']);
$modelProdUp=consultasSQL::clean_string($_POST['prod-model']);
$presentacionProdUp=consultasSQL::clean_string($_POST['prod-presentacion']);
...
if(consultasSQL::UpdateSQL("producto", "NombreProd='$nameProdUp', loteProd='$loteProdUp', proveedorProd='$proveedorProdUp',CodigoCat='$catProdUp',presentacion='$presentacionProdUp',vencimiento='$descProdUp',invima='$modelProdUp',Marca='$marcaProdUp',Stock='$stockProdUp',NITProveedor='$proveProdUp',Estado='$EstadoProdUp'", "CodigoProd='$codeOldProdUp'")){
   echo '<script>
    swal({
