...
<nav id="navbar-auto-hidden">
        <div class="row hidden-xs">
            <div class="col-xs-4">
                <p class="text-navbar tittles-pages-logo">PROSALCO IPS</p> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;  
                <em><?php date_default_timezone_set("America/Bogota");echo date("d/m/Y  h:i a");?></em>
            </div>
            <div class="col-xs-8">
            ...
            <form action="process/login.php" method="post" role="form" class="FormCatElec" data-form="login">
               ...
               <div class="radio">
                ...
                <div class="modal-footer">
                  ...
                  <button type="button" class="btn btn-danger btn-raised btn-sm" data-dismiss="modal">Cancelar</button></br></br>
                  <a href="inven\index.php"><button type="button"  class="btn btn-info btn-raised btn-sm">Inventario</button></a>
                  <a href=""><button type="button"  class="btn btn-success btn-raised btn-sm">sedes</button></a>
                </div>
    ...
    <div id="mobile-menu-list" class="hidden-sm hidden-md hidden-lg">
        <br>
        <h3 class="text-center tittles-pages-logo">PROSALCO IPS</h3>
