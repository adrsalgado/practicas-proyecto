...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 24-10-2022 a las 22:46:52
...
(4, '45.jpg', 'image/jpeg'),
(8, 'otorrino.jpg', 'image/jpeg'),
(9, 'Acetaminofén.jpg', 'image/jpeg'),
(10, 'espejo bucal.jpg', 'image/jpeg');
...
CREATE TABLE `products` (
  ...
  `invima` varchar(30) DEFAULT NULL,
...
INSERT INTO `products` (`id`, `producto`, `lote`, `name`, `stock`, `invima`, `categorie_id`, `media_id`, `date`, `presentacion`, `proveedor`, `vencimiento`, `marca`) VALUES
(1, 'PARACETAMOL', '1234', 'Bloquea la generación del impulso doloroso a nivel periférico.', '150', '14169', 4, 1, '2022-10-21 19:10:55', '16 COMPRIMIDOS ', 'DISTRIBUIDROGAS', '2022-10-21 19:10:55', 'RATIOPHARM'),
(5, 'Acetaminofen', '1234', 'analgésicas y antipiréticas', '1225', 'INVIMA 2017M-007695-R3\n', 4, 3, '2022-10-18 21:07:14', 'CAJA X 100 TABLETAS ', '\nLaboratorios América S.A.\n', '2024-06-18 05:23:14', 'TYLENOL®'),
(8, 'Micro pinza auricular de Hartm', '1234', 'Longitud: 80 mm\n•Longitud de punta: 4 mm\n• Ancho de punta: 0,6 mm', '34', '	\nINVIMA 2021M-002103-R3', 8, 2, '2022-10-18 21:20:32', '1 UND', 'FAICO', '2026-10-13 09:44:14', '	GIMA'),
(22, 'adriana salgado', '01082021', 'franqueisi toro', '1', '01082021', 3, 0, '2022-10-24 17:47:06', 'amor', 'hqdq', '2022-10-24 17:47:06', 'be'),
(2761, '44', 'trgf', '', '15', '147A1D', 4, 4, '2022-10-24 18:34:15', 'franqueisi toro', 'GENFAR', '0000-00-00 00:00:00', '2022-10-21');
...
(1, 'Admin Users', 'admin', 'd033e22ae348aeb5660fc2140aec35850c4da997', 1, 'pzg9wa7o1.jpg', 1, '2022-10-24 18:34:31'),
(2, 'Special User', 'special', 'ba36b97a41e7faf742ab09bf88405ac04f99599a', 2, 'iuwrdz9n2.JPG', 1, '2022-10-24 18:28:14'),
...
(12, 'jhon edilson', 'jhone', 'b3c0730cf3f50613e40561e67c871fdb92820cf9', 1, 'no_image.jpg', 1, NULL);
...
--
ALTER TABLE `products`
  MODIFY `id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2768;
