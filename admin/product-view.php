<p class="lead">
    Productos actualizados del inventario de insumos de la sede administrativa.
</p>
	...
	<div class="row">
        <div class="col-xs-12">
            <div class="container-form-admin">
                <h3 class="text-primary text-center">Agregar un producto al catalogo</h3>
                        ...
                        <div class="row">
                            ...
                            <div class="col-xs-12 col-sm-6 col-md-4">
                              <div class="form-group label-floating">
                                ...
                                <input type="text" class="form-control" required name="prod-lote">
                              </div>
                            </div>
                            <div class="col-xs-12 col-sm-6 col-md-4">
                              <div class="form-group label-floating">
                                <label class="control-label">presentacion</label>
                                <input type="text" class="form-control" required name="prod-presentacion">
                              </div>
                            </div>
                            <div class="col-xs-12 col-sm-6 col-md-4">
                              <div class="form-group label-floating">
                                <label class="control-label">Vencimiento</label>
                                <input type="date" class="form-control" required maxlength="7" pattern="[0-9]{1,2}{/}" name="prod-desc-price" value="0">
                              </div>
                            </div>
                            <div class="col-xs-12 col-sm-6 col-md-4">
                              <div class="form-group label-floating">
