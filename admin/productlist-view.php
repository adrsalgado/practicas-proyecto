                  ...
                  <table class="table table-striped table-hover">
                      <thead class="">
                          <tr>
                              ...
                              <th class="text-center">Invima</th>
                      ...
                      <tbody>
                        ...
                        <tr>
                        	...
                        	<td class="text-center"><?php echo $prod['lote']; ?></td>
                            <td class="text-center"><?php echo $prod['presentacion']; ?></td>
                        	<td class="text-center"><?php echo $prod['invima']; ?></td>
