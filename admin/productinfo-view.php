                ...
                <form action="./process/updateProduct.php" method="POST" enctype="multipart/form-data" class="FormCatElec" data-form="update">
                    ...
                    <div class="container-fluid">
                        <div class="row">
                            ...
                            <div class="col-xs-12 col-sm-6 col-md-4">
                              <div class="form-group label-floating">
                                <label class="control-label">Invima</label>
                                <input type="text" class="form-control" value="<?php echo $prod['invima']; ?>" required name="prod-model">
                              </div>
                            </div>
                            <div class="col-xs-12 col-sm-6 col-md-4">
                              <div class="form-group label-floating">
                                <label class="control-label">Lote</label>
                                <input type="text" class="form-control" value="<?php echo $prod['lote']; ?>" required name="prod-lote">
                              </div>
                            </div>
                            <div class="col-xs-12 col-sm-6 col-md-4">
                              <div class="form-group label-floating">
                                <label class="control-label">Presentacion</label>
                                <input type="text" class="form-control" value="<?php echo $prod['presentacion']; ?>" required name="prod-presentacion">
                              </div>
                            </div>
                            <div class="col-xs-12 col-sm-6 col-md-4">
                              <div class="form-group label-floating">
                                <label class="control-label">Vencimiento</label>
                                <input type="date" class="form-control" value="<?php echo $prod['vencimiento']; ?>" required maxlength="7" pattern="[0-9]{1,2}" name="prod-desc-price" >
                              </div>
                            </div>
                            <div class="col-xs-12 col-sm-6 col-md-4">
                              <div class="form-group label-floating">
