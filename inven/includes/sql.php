...
/*--------------------------------------------------------------*/
 ...
 function find_recent_product_added($limit){
   global $db;
   $sql   = " SELECT p.id,p.name,p.lote,p.producto,p.media_id,c.name AS categorie,";
...
function find_sale_by_dates($start_date,$end_date){
  ...
  $sql  = "SELECT s.date, p.lote,p.invima,p.producto,p.presentacion,p.proveedor,p.marca,p.vencimiento";
