       ...
       <br>
        <div class="container">
            <div class="page-header">
              <h1>BÚSQUEDA DE PRODUCTOS <small class="tittles-pages-logo">PROSALCO IPS</small></h1>
            </div>
              ...
              <div class="container-fluid">
                <div class="row">
                  <?php
                    ...
                    $consultar_productos=mysqli_query($mysqli,"SELECT SQL_CALC_FOUND_ROWS * FROM producto WHERE NombreProd LIKE '%".$search."invima".$search."%' OR Marca LIKE '%".$search."%' LIMIT $inicio, $regpagina");
