    ...
    <section id="container-pedido">
        <div class="container">
            <div class="page-header">
              <h1>CARRITO DE COMPRAS <small class="tittles-pages-logo">PROSALCO IPS</small></h1>
            </div>
            <br><br><br>
            <div class="row">
                <div class="col-xs-12">
                    <?php
                        ...
                        if(!empty($_SESSION['carro'])){
                            $suma = 0;
                            $sumaA = 0;
                            echo '<table class="table table-bordered table-hover"><thead><tr class="bg-success"><th>lote</th><th>Nombre</th><th>presentacion</th><th>vencimiento</th><th>Subtotal</th><th>Acciones</th></tr></thead>';
                            foreach($_SESSION['carro'] as $codeProd){
                                ...
                                while($fila = mysqli_fetch_array($consulta, MYSQLI_ASSOC)) {
                                    $pref=number_format(($fila['Precio']-($fila['Precio']*($fila['vencimiento']/100))), 2, '.', '');
                                        echo "<tbody>
                                            <tr>
                            ...
                            echo '
                            <p class="text-center">
                            <a href="product.php" class="btn btn-primary btn-raised btn-lg">Mas insumos</a>
                            <a href="process/vaciarcarrito.php" class="btn btn-success btn-raised btn-lg">Vaciar el carrito</a>
                            <a href="pedido.php" class="btn btn-danger btn-raised btn-lg">Generar Factura</a>
                            </p>
                            ';
                        }else{
